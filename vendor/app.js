...
function calculateModel(params, trajectories) {
  ...
  for (let i = 0; i < 11; i++) {
    ...
    const midSizedExpenses = midSizedStudents * (BASE_ASSUMPTIONS.midSized.headcount + BASE_ASSUMPTIONS.midSized.programs + BASE_ASSUMPTIONS.midSized.misc + BASE_ASSUMPTIONS.midSized.timeback + BASE_ASSUMPTIONS.midSized.otherFacilities) * params.costInflation;
    ...
    const flagshipExpenses = flagshipStudents * (BASE_ASSUMPTIONS.flagship.headcount + BASE_ASSUMPTIONS.flagship.programs + BASE_ASSUMPTIONS.flagship.misc + BASE_ASSUMPTIONS.flagship.timeback + BASE_ASSUMPTIONS.flagship.otherFacilities) * params.costInflation;
  ...
  const tierData = {
    ...
    midSized: {
      ...
      costs: [{
        ...
        value: BASE_ASSUMPTIONS.midSized.otherFacilities
      }],
    ...
    flagship: {
      ...
      costs: [{
        ...
        name: 'Other Facilities',
        value: BASE_ASSUMPTIONS.flagship.otherFacilities
      }],
